  ...
  return (
    <Card className="prescription-preview-card" title={<CustomTitle />}>
      <div id="print-subscription">
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Text style={{ marginTop: 4, color: '#74798c', fontWeight: 'bold', fontSize: 9 }}>
              Dr {prescriptionFakeData.cabinetInfo.doctor}
            </Text>
            <Text style={{ marginTop: 4, color: '#74798c', fontWeight: 'bold', fontSize: 9 }}>
              {prescriptionFakeData.cabinetInfo.speciality}
            </Text>
          </div>
          <div
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <Text style={{ textAlign: 'right', marginBottom: 2, color: '#74798c', fontSize: 9 }}>
                {prescriptionFakeData.cabinetInfo.phoneNumber1}
              </Text>
              <Text style={{ textAlign: 'right', marginBottom: 2, color: '#74798c', fontSize: 9 }}>
                {prescriptionFakeData.cabinetInfo.phoneNumber2}
              </Text>
            </div>
        ...
        <div
          style={{ padding: '24px 20px', width: '100%', display: 'flex', flexDirection: 'column' }}
        >
          <Text style={{ display: 'block', fontWeight: 'bold', textAlign: 'center', fontSize: 16 }}>
            Prescription
          </Text>
          <div
            style={{
          ...
          <p style={{ marginTop: 44, fontSize: 10, marginBottom: 80 }}>{prescription.note}</p>
          <div
            style={{
              position: 'absolute',
              left: 0,
