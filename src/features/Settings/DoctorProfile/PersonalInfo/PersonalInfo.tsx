        ...
        <Row gutter={[35, 16]}>
          ...
          <Col span={12}>
            <Label
              ...
              error={touched.secondarySpecialty ? (errors.secondarySpecialty as string) : undefined}
            />
            <Form.Item
              validateStatus={
          ...
          <Col span={24}>
            ...
            />
            <Form.Item
              validateStatus={touched.biography && Boolean(errors.biography) ? 'error' : undefined}
            >
              <Input.TextArea
