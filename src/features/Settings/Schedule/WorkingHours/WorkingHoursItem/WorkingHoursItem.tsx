                ...
                <Col span={10}>
                  <div>
                    <Button
                      ...
                      onClick={() => {
                        handleChange('afternoonStart', '08:00' as never);
                        handleChange('afternoonEnd', '08:00' as never);
                      }}
                    >
                ...
                <>
                  ...
                  <Col span={4}>
                    <Button
                      ...
                      style={{ marginTop: 18 }}
                      onClick={() => {
                        handleChange('afternoonStart', null as never);
                        handleChange('afternoonEnd', null as never);
                      }}
                    >
